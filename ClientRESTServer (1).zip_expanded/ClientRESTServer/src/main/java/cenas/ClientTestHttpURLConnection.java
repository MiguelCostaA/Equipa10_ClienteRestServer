...
public class ClientTestHttpURLConnection {
	...
	private static void addTarefa() {
		...
		try {
			URL url = new URL("http://localhost:8080/ProjetoREST/tarefa/addTarefa");
			...
			con.setDoInput(true);
			String postData = gson.toJson(new Tarefa("Limpar o quarto", "Arrumar a cama, limpar a secretária", "19/04/2024", "Alta"), Tarefa.class);
	...
	private static void updateTarefa() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/tarefa/updateTarefa");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
	...
	/**
     * Método para obter informações sobre todas as Tarefas.
     */
	private static void getTarefa() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/tarefa/getTarefa");
	...
	private static void addCategoria() {
		...
		try {
			URL url = new URL("http://localhost:8080/ProjetoREST/categoria/addCategoria");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("POST");
	...
	private static void updateCategoria() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/categoria/updateCategoria");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("PUT");
	...
	/**
	 * Método para obter informações sobre todas as Categorias.
	 */
	private static void getCategoria() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/categoria/getCategoria");
			conn = (HttpURLConnection) url.openConnection();
			conn.setRequestMethod("GET");
			conn.setRequestProperty("Accept", "application/json");
			conn.connect();
	...
	private static void addEstado() {
		...
		try {
			URL url = new URL("http://localhost:8080/ProjetoREST/estado/addEstado");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("POST");
	...
	private static void updateEstado() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/estado/updateEstado");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("PUT");
	...
	/**
	 * Método para obter informações sobre todos os Estados.
	 */
	private static void getEstado() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/estado/getEstado");
			conn = (HttpURLConnection) url.openConnection();
			conn.setRequestMethod("GET");
			conn.setRequestProperty("Accept", "application/json");
			conn.connect();
	...
	private static void addRecorrencia() {
		...
		try {
			URL url = new URL("http://localhost:8080/ProjetoREST/recorrencia/addRecorrencia");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("POST");
	...
	private static void updateRecorrencia() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/recorrencia/updateRecorrencia");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("PUT");
	...
	/**
	 * Método para obter informações sobre todas as Recorrências.
	 */
	private static void getRecorrencia() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/recorrencia/getRecorrencia");
			conn = (HttpURLConnection) url.openConnection();
			conn.setRequestMethod("GET");
			conn.setRequestProperty("Accept", "application/json");
			conn.connect();
	...
	private static void addUtilizador() {
		...
		try {
			URL url = new URL("http://localhost:8080/ProjetoREST/utilizador/addUtilizador");
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("POST");
			...
			con.setDoOutput(true);
			con.setDoInput(true);
			String postData = gson.toJson(new Utilizador("Carlinhos Pereira", "carlitos123@gmail.com", "bananinha1234"), Utilizador.class);
	...
	/**
	 * Método para obter informações sobre todos os Utilizadores.
	 */
	private static void getUtilizador() {
		...
		try {
			...
			URL url = new URL("http://localhost:8080/ProjetoREST/utilizador/getUtilizador");
			conn = (HttpURLConnection) url.openConnection();
			conn.setRequestMethod("GET");
			conn.setRequestProperty("Accept", "application/json");
			conn.connect();
